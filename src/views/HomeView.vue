<template>
  <main>
    <div class="relative z-10">
      <div
        class="absolute inset-2 bottom-0 rounded-4xl ring-1 ring-black/5 ring-inset bg-linear-115 from-[#fff1be] from-28% via-[#ee87cb] via-70% to-[#b060ff]">
      </div>
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-7xl">
              ...
              <div
                ...
                <div class="relative flex gap-6">
                  <div class="py-3 group/item relative">
                    ...
                    <a title="Home" data-headlessui-state="" href="/">
                      <svg width="127" height="34" viewBox="0 0 127 34" class="h-9 overflow-visible">
                        <g opacity="1" style="
                            transform: none;
                            transform-origin: 17.0005px 17.0005px;
                          ">
                          <path
                        ...
                        <g opacity="1" style="
                            transform: none;
                            transform-origin: 17px 17.0004px;
                          ">
                          <path
                  ...
                  <div class="relative hidden items-center py-3 lg:flex">
                    <a class="flex items-center gap-1 rounded-full bg-fuchsia-950/35 px-3 py-0.5 text-sm/6 font-medium text-white data-hover:bg-fuchsia-950/30"
                      data-headlessui-state="" href="/blog/radiant-raises-100m-series-a-from-tailwind-ventures">Radiant
                      raises $100M Series A from Tailwind Ventures<svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon" class="size-4">
                ...
                <nav class="relative hidden lg:flex">
                  <div class="relative flex group/item relative">
                    <svg viewBox="0 0 15 15" aria-hidden="true"
                      ...
                      data-headlessui-state="" href="/pricing">Pricing</a>
                  </div>
                  <div class="relative flex group/item relative">
                    <svg viewBox="0 0 15 15" aria-hidden="true"
                      class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                      ...
                      class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                      data-headlessui-state="" href="/company">Company</a>
                  </div>
                  <div class="relative flex group/item relative">
                    <svg viewBox="0 0 15 15" aria-hidden="true"
                      class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                      ...
                      class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                      data-headlessui-state="" href="/blog">Blog</a>
                  </div>
                  <div class="relative flex group/item relative">
                    <svg viewBox="0 0 15 15" aria-hidden="true"
                      class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                      ...
                      class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                      data-headlessui-state="" href="/login">Login</a>
                  </div>
                </nav>
          ...
          <div class="pt-16 pb-24 sm:pt-24 sm:pb-32 md:pt-32 md:pb-48">
            <h1
              class="font-display text-6xl/[0.9] font-medium tracking-tight text-balance text-gray-950 sm:text-8xl/[0.8] md:text-9xl/[0.8]">
              Close every deal.
            </h1>
            ...
            <div class="mt-12 flex flex-col gap-x-6 gap-y-4 sm:flex-row">
              <a @click="modal.openModal"
                class="inline-flex items-center justify-center px-4 py-[calc(--spacing(2)-1px)] rounded-full border border-transparent bg-gray-950 shadow-md text-base font-medium whitespace-nowrap text-white data-disabled:bg-gray-950 data-disabled:opacity-40 data-hover:bg-gray-800"
                data-headlessui-state="" href="#">Get started</a><a
                ...
                data-headlessui-state="" href="/pricing">See pricing</a>
            </div>
          </div>
        </div>
      </div>
